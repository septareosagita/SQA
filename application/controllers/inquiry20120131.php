...
class inquiry extends CI_Controller {
	...
	function search() {
        ...
        //update 20120130 tambahan where untuk query sql
        //and AUDIT_FINISH_PDATE is null 
		...
		$non_sqa = ($user_grpauth != '04' && $user_grpauth != '05' && $user_grpauth != '06' && $user_grpauth != '07' && $user_grpauth != '08' && $user_grpauth != '09') ? 1 : 0;
