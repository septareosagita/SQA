...
class m_sqa_dfct_model extends CI_Model {

    var $table_name = 'M_SQA_DFCT';
    var $table_pk = 'DFCT_ID';
    ...
    function insert($data) {
        return $this->db->insert('M_SQA_DFCT', $data);
    }
    ...
    function delete($keys) {
        return $this->db->delete('M_SQA_DFCT', $keys);
    }
}
