...
class m_sqa_div_model extends CI_Model {

    var $table_name = 'V_SQA_DIV';
    var $table_model = 'M_SQA_DIV';
    var $table_pk = 'DIV_ID';
    ...
    function select($limit='', $order='', $condition='', $fields = '*') {
        $sql = sql_select($this->table_model, $limit, $order, $condition, $fields, $this->table_pk);
    ...
    function insert($data) {
        return $this->db->insert('M_SQA_DIV', $data);
    }
    ...
    function delete($keys) {
        return $this->db->delete('M_SQA_DIV', $keys);
    }
}
