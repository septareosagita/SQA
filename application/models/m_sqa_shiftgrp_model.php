...
class m_sqa_shiftgrp_model extends CI_Model {

    var $table_name = 'M_SQA_SHIFTGRP';
    var $table_model = 'M_SQA_SHIFTGRP';
    var $table_pk = 'SHIFTGRP_ID';
    ...
    function update($data, $keys) {
        return $this->db->update($this->table_model, $data, $keys);
    }
