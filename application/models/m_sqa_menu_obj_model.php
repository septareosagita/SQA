...
class m_sqa_menu_obj_model extends CI_Model {

    var $table_name = 'V_SQA_MENU_OBJ';
    var $table_pk = 'MENU_ID';
    ...
    function insert($data) {
        return $this->db->insert('M_SQA_MENU_OBJ', $data);
    }
    ...
    function delete($keys) {
        return $this->db->delete('M_SQA_MENU_OBJ', $keys);
    }
