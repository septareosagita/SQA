...
$(function(){
         ...
         var result = hasil_du_func.toFixed(6);
         if(hasil_plus ==''){
          $("#hasil").html('0.000000');       
         }
         else{
...
<div class="columns">
  ...
  <tr>
    ...
    <?php foreach ($list_rank as $l):     
                     ...
                     //rank Assembly 
                      if($rank_nm =='A' && $rank_desc =='Apperance' && $dfct_ctg =='A')
                      {$rankA_A_App += $nilai;}
                        
                       if($rank_nm =='A' && $rank_desc =='Function' && $dfct_ctg =='A')
                      {$rankA_A_Func += $nilai;}                   
                       
                        if($rank_nm =='B' && $rank_desc =='Apperance' && $dfct_ctg =='A')
                      {$rankB_A_App += $nilai;}
                                            
                        if($rank_nm =='B' && $rank_desc =='Function' && $dfct_ctg =='A')
                      {$rankB_A_Func = $nilai;}
                                            
                       //rank Painting 
                      if($rank_nm =='A' && $rank_desc =='Apperance' && $dfct_ctg =='P')
                      {$rankA_P_App += $nilai;}
                                           
                       if($rank_nm =='A' && $rank_desc =='Function' && $dfct_ctg =='P')
                      {$rankA_P_Func += $nilai;}
                                            
                        if($rank_nm =='B' && $rank_desc =='Apperance' && $dfct_ctg =='P')
                      {$rankB_P_App += $nilai;}
                                             
                        if($rank_nm =='B' && $rank_desc =='Function' && $dfct_ctg =='P')
                      {$rankB_P_Func += $nilai;}
                                             
                       //rank Driving
                      if($rank_nm =='A' && $rank_desc =='Apperance' && $dfct_ctg =='D')
                      {$rankA_D_App += $nilai;}
                                           
                       if($rank_nm =='A' && $rank_desc =='Function' && $dfct_ctg =='D')
                      {$rankA_D_Func += $nilai;}
                      
                        if($rank_nm =='B' && $rank_desc =='Apperance' && $dfct_ctg =='D')
                      {$rankB_D_App += $nilai;}
                                            
                        if($rank_nm =='B' && $rank_desc =='Function' && $dfct_ctg =='D')
                      {$rankB_D_Func += $nilai;}   
                   endforeach ?>
  ...
  <tr>
    <td style="text-align:center; background-color:#EAEAEA;"><img src="<?= base_url() ?>assets/style/images/func.gif" width="12" heigth="12" /></td>
    <td style="text-align:center;background-color:#EAEAEA;"><img src="<?= base_url() ?>assets/style/images/app.gif" width="12" heigth="12" /></td>
    <td style="text-align:center;background-color:#EAEAEA;"><img src="<?= base_url() ?>assets/style/images/func.gif" width="12" heigth="12" /></td>
    <td style="text-align:center;background-color:#EAEAEA;"><img src="<?= base_url() ?>assets/style/images/app.gif" width="12" heigth="12" /></td>
    </tr>
...
<table width="98%" class="data2" border="1" cellpadding="0" cellspacing="0" style="text-align:center; margin:10px;">
  ...
  <tr>
    ...
    <td style="text-align:center;"><img src="<?= base_url() ?>assets/style/images/func.gif" width="12" heigth="12" /> A</td>
     <?php 
     $bulan_max_fiscal; 
     $bulan_min_fiscal;
    ...
    <td><?=$total_rankA_func ?></td>
    <td><?=$total_rankA_func/$count_m_pdate ?></td>
    <td style="text-align:center;">D/U FUNC</td>
  </tr>
  <tr>
    <td style="text-align:center;"><img src="<?= base_url() ?>assets/style/images/app.gif" width="12" heigth="12" /> A</td>
     <?php 
     $bulan_max_fiscal; 
     $bulan_min_fiscal;
       ...
       // echo $pdate_fiscal.".".$year_fiscal."<br>";
        ...
        foreach ($list_rank_DU as $l):
           // $dfct_ctg = $l->DFCT_CTG;
            ...
            //rank A func
            if (($pdate_fiscal == $pdate) && ($fiscal_year == $year_fiscal) && ($rank_nm =='Apperance A')){                               
                $rankA_App += $num_dfct ;
            }
     ...
     <td><?=$total_rankA_App ?></td>   
    <td><?=$total_rankA_App/$count_m_pdate ?></td>
    <td rowspan="4"><div id="hasil">&nbsp;</div></td>
  </tr>
  <tr>
    <td style="text-align:center;"><img src="<?= base_url() ?>assets/style/images/func.gif" width="12" heigth="12" /> B</td>
    <?php 
    ...
    <td><?=$total_rankB_func ?></td>
    <td><?=$total_rankB_func/$count_m_pdate ?></td>
    </tr>
  <tr>
    <td style="text-align:center;"><img src="<?= base_url() ?>assets/style/images/app.gif" width="12" heigth="12" /> B</td>
    <?php 
       ...
       // echo $pdate_fiscal.".".$year_fiscal."<br>";
        ...
        foreach ($list_rank_DU as $l):
           // $dfct_ctg = $l->DFCT_CTG;
            ...
            //rank A func
            if (($pdate_fiscal == $pdate) && ($fiscal_year == $year_fiscal) && ($rank_nm =='Apperance B')){                               
                $rankB_App += $num_dfct ;
            }
    ...
    <td><?=$total_rankB_App ?></td>
    <td><?=$total_rankB_App/$count_m_pdate ?></td>
    </tr>
  ...
  <tr style="background-color:#EAEAEA;">
    ...
    <th><?= $total_unit_veh = ($total_rankA_func+$total_rankA_App+$total_rankB_func+$total_rankB_App) ?></th>
    <th><?= (($total_rankA_func/$count_m_pdate)+($total_rankA_App/$count_m_pdate)+
            ($total_rankB_func/$count_m_pdate)+($total_rankB_App/$count_m_pdate)) ?></th>
    </tr>
  <tr style="background-color:#EAEAEA;">
    ...
    <th><?=$total_tot_veh/$count_m_pdate?></th>
    <th>&nbsp;</th>
  </tr>
  <tr>
    ...
    <td style="text-align:center;"><img src="<?= base_url() ?>assets/style/images/func.gif" width="12" heigth="12" /> A</td>
     ...
     echo "<td>"; 
       ...
       // echo $pdate_fiscal.".".$year_fiscal."<br>";
        ...
        echo number_format(($rankA_func/$tot_veh),6);                          
        }
		else {
		echo '';
		}                                    
    ...
    <td><?= number_format($total_rankA_func/$unit_veh,6)?></td>
    <td><?= number_format(($total_rankA_func/$unit_veh)/$count_m_pdate,6) ?></td>
   ...
   <?php 
     ...
     echo "<td>"; 
       ...
       // echo $pdate_fiscal.".".$year_fiscal."<br>";
        ...
        echo number_format(($rankA_App/$tot_veh),6);                          
        }
		else {
		echo '';
		}                                    
    ...
    <td><?= number_format($total_rankA_App/$unit_veh,6) ?></td>
    <td><?= number_format(($total_rankA_App/$unit_veh)/$count_m_pdate,6) ?></td>
    <td rowspan="4"><?= number_format(($total_rankA_App+total_rankB_App)/$unit_veh,6) ?></td>
  </tr>
  <tr>
    <td style="text-align:center;"><img src="<?= base_url() ?>assets/style/images/func.gif" width="12" heigth="12" /> B</td>
     <?php 
     ...
     echo "<td>"; 
       ...
       // echo $pdate_fiscal.".".$year_fiscal."<br>";
        ...
        echo number_format(($rankB_func/$tot_veh),6);                          
        }
		else {
		echo '';
		}                                    
    ...
    <td><?= number_format($total_rankB_func/$unit_veh,6) ?></td>
    <td><?= number_format(($total_rankB_func/$unit_veh)/$count_m_pdate,6) ?></td>
    </tr>
  <tr>
    <td style="text-align:center;"><img src="<?= base_url() ?>assets/style/images/app.gif" width="12" heigth="12" /> B</td>
   <?php 
     ...
     echo "<td>"; 
       ...
       // echo $pdate_fiscal.".".$year_fiscal."<br>";
        ...
        echo number_format(($rankB_App/$tot_veh),6);                          
        }
		else {
		echo '';
		}                                    
    ...
    <td><?= number_format($total_rankB_App/$unit_veh,6) ?></td>
    <td><?= number_format(($total_rankB_App/$unit_veh)/$count_m_pdate,6) ?></td>
    </tr>
  <tr style="background-color:#EAEAEA;">
    <td style="text-align:center;">TOTAL</td>
     ...
     echo "<td>"; 
       ...
       // echo $pdate_fiscal.".".$year_fiscal."<br>";
        ...
        endforeach;
		if ($tot_rank/$tot_veh !=''){
        echo number_format(($tot_rank/$tot_veh),6);                          
        }
		else {
		echo '';
		}                                    
    ...
    <th><?= number_format(($total_unit_veh/$unit_veh),6) ?></th>
    <th><?= number_format(($total_unit_veh/$unit_veh)/$count_m_pdate,6) ?></th>
    </tr>
</table>
      ...
      $rankB_A_Func_du = $rankB_A_App_du = $rankA_A_Func_du = $rankA_A_App_du = $ta_du = '-';
        ...
        foreach ($list_rank_du as $l):
                     ...
                     $fiscal_year = date("Y",strtotime($l->FISCAL_YEAR));
                      ...
                      //rank Assembly 
                      if($rank_nm =='A' && $rank_desc =='Apperance' && $dfct_ctg =='A' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      {  $rankA_A_App_du += $nilai;}
            
                       if($rank_nm =='A' && $rank_desc =='Function' && $dfct_ctg =='A' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      { $rankA_A_Func_du += $nilai;}                   
                       
                        if($rank_nm =='B' && $rank_desc =='Apperance' && $dfct_ctg =='A' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      { $rankB_A_App_du += $nilai;}
                                            
                        if($rank_nm =='B' && $rank_desc =='Function' && $dfct_ctg =='A' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
      ...
      $rankA_P_App_du = $rankA_P_Func_du = $rankB_P_App_du = $rankB_P_Func_du = $tp_du = '-';
       ...
       foreach ($list_rank_du as $l):     
                     ...
                     $fiscal_year = date("Y",strtotime($l->FISCAL_YEAR)); 
                      ...
                      //rank Painting 
                      if($rank_nm =='A' && $rank_desc =='Apperance' && $dfct_ctg =='P' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      {$rankA_P_App_du += $nilai;}
                                           
                       if($rank_nm =='A' && $rank_desc =='Function' && $dfct_ctg =='P' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      {$rankA_P_Func_du += $nilai;}
                                            
                        if($rank_nm =='B' && $rank_desc =='Apperance' && $dfct_ctg =='P' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      {$rankB_P_App_du += $nilai;}
                                             
                        if($rank_nm =='B' && $rank_desc =='Function' && $dfct_ctg =='P' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
     ...
     echo "<td>"; 
      ...
      foreach ($list_rank_du as $l):  
                     ...
                     $fiscal_year = date("Y",strtotime($l->FISCAL_YEAR)); 
                       ...
                       //rank Driving
                      if($rank_nm =='A' && $rank_desc =='Apperance' && $dfct_ctg =='D' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      {$rankA_D_App_du += $nilai;}
                                           
                       if($rank_nm =='A' && $rank_desc =='Function' && $dfct_ctg =='D' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      {$rankA_D_Func_du += $nilai;}
                      
                        if($rank_nm =='B' && $rank_desc =='Apperance' && $dfct_ctg =='D' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
                      {$rankB_D_App_du += $nilai;}
                                            
                        if($rank_nm =='B' && $rank_desc =='Function' && $dfct_ctg =='D' && $pdate_fiscal == $pdate && $fiscal_year == $year_fiscal)
  ...
  <td>&nbsp;</td>
    ...
    <?php 
     ...
     echo "<th>"; 
        ...
        //debug_array($list_rank_DU);
        foreach ($total_list_rank_du as $l):
           
            $total_unit_month2;
            $total = $l->DU_MDL_CTG_RANK_MONTHLY;
            $pdate = date("n",strtotime($l->PDATE));
            $bulankurangsatu;
            $fiscal_year = date("Y",strtotime($l->FISCAL_YEAR));
            
           // echo $pdate_fiscal."=".$pdate."=".$total."<br/>";
         ...
         endforeach;       
                  echo  number_format($nilai_td_du+$nilai_tp_du+$nilai_ta_du,2);                     
     echo "</th>";
