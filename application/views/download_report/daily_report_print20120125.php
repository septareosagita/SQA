...
<!------------------------------------------------------daily 3-------------------------------------------->               
        ...
        <div class="daily_3a">
          <table width="100% "border="0" cellpadding="2" cellspacing="0" bordercolor="#000000" class="data2" style="font-size:10px;">
            <tr>
            ...
            <tr bgcolor="#EAEAEA">
              ...
              <th style="border:1px solid #888888;" colspan="<?= $sparator ?>"><?= $kurangbulan = date("F y", mktime(0,0,0,date("m")-1,date("d")-1,date("Y"))); ?></th>
              <th style="border:1px solid #888888;" colspan="<?= $sparator2 ?>"><?= date("F y"); ?></th>
            ...
            <tr bgcolor="#EAEAEA">
              ...
              <th width="13" style="border:1px solid #888888;"><?= $r ?></th>
              <?php endforeach; ?>
            </tr>
           <?php 
                            $cek = " ";
  ...
  <tr <?=$tr_style?>>
    <td style="border:1px solid #888888;vertical-align:middle; text-align: center;"><?= $h; ?>
      </td>
    <td style="border:1px solid #888888;"><?= $l->DFCT ?>
        <?= $l->DESCRIPTION ?></td>
    <td style="border:1px solid #888888; vertical-align:middle; text-align: center;"><?php
                        ...
                        <?php if($l->RANK_NM =='Function A' || $l->RANK_NM =='Appearance A'){
                            ...
                            echo 'B';}
                        ?></td>
    <td style="border:1px solid #888888; vertical-align:middle; text-align: center;"><?php if($l->INSP_ITEM_FLG =='0'){
                            echo 'No';}
                        ...
                        <td style="border:1px solid #888888; vertical-align:middle; text-align: center;">
						<?php
    ...
    <td style="border:1px solid #888888; vertical-align:middle; text-align: center;"><?php if($l->REPAIR_FLG =='0'){
                            echo 'No';}
    ...
    <td style="border:1px solid #888888; vertical-align:middle; text-align: center;"><?php 
                        ...
                        ?></td>
    <td style="border:1px solid #888888; vertical-align:middle; text-align: center;"><?= substr($l->SQA_SHIFTGRPNM,0,1); ?></td>
    <?php
                        ...
                        $tgl = 35-$i;
                        echo '<td style="border:1px solid #888888; vertical-align:middle; text-align: center;">'; 
    ...
    <td style="border:1px solid #888888; vertical-align:middle; text-align: center;"><?= $l->SHOP_NM ?></td>
    <td style="vertical-align:middle; text-align: center; border:1px solid #888888;"><?= ($l->APPROVE_PDATE_REPLY !='' && $l->REPLY_TYPE =='R')?'<img src="'. base_url(). 'assets/style/images/black.gif" width="15" heigth="15" />':'<img src="'. base_url(). 'assets/style/images/blank.gif" width="15" heigth="15" />' ?></td>
    <td style="vertical-align:middle; text-align: center; border:1px solid #888888;"><?= ($l->APPROVE_PDATE_REPLY !='' && $l->REPLY_TYPE =='O')?'<img src="'. base_url(). 'assets/style/images/black.gif" width="15" heigth="15" />':'-' ?></td>
    <td style="vertical-align:middle; text-align: center; border:1px solid #888888;"><?= ($l->CLOSE_FLG =='0')?'Open':'Closed' ?></td>
  </tr>
  <?php } endforeach; ?>
          </table>
        </div> 
