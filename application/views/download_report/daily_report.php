               ...
               <div class="daily_1c">
                   ...
                   endforeach ?>
                    ...
                    <?php foreach ($total_DU_Mon as $d): 
                        ...
                        $rec_zero_dfct_day_num1 = $d->REC_ZERO_DFCT_DAY_NUM;
...
<!------------------------------------------------------daily 4-------------------------------------------->               
            ...
            <div class="daily_4a">
                    ...
                    <tr>
                      <th width="20%" rowspan="2">TOTAL ZERO DEFECT DAY <?= date('F', strtotime($date_daily_report)) ?> : <?= ($zero_dfct_day_num !='')? $zero_dfct_day_num: 0; ?> DAYS<br />
                      TOTAL WORKING DAY ON <?= date('F', strtotime($date_daily_report)) ?> : <?=$total_working_day ?> DAYS</th>
                    ...
                    <tr>
                      <th rowspan="2">PAST RECORD DAY (<?= ($total_defect !='')? date('F Y', strtotime($date_daily_report)) : '-'; ?>) 
