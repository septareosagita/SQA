...
<table id="demoTable" class="data" width="250%">
	<tr style="background:#dadada;">
		...
		<th width="2%" style="vertical-align:middle; text-align: center">Outflow
		<br/>
		Temp</th>
		<th width="2%" style="vertical-align:middle; text-align: center">Outflow
		<br/>
		Fix</th>
		<th width="2%" style="vertical-align:middle; text-align: center">Problem
		<br/>
		Temp</th>
		<th width="2%" style="vertical-align:middle; text-align: center">Problem
		<br/>
		...
		<th width="3%"  style="vertical-align:middle; text-align: center">SQA
		<br />
		Shift</th>
		<th width="3%"  style="vertical-align:middle; text-align: center">Prod
		<br />
		Shift</th>
		<th width="3%"  style="vertical-align:middle; text-align: center">Insp
		<br />
		Shift</th>
		...
		<th width="1%"  style="vertical-align:middle; text-align: center">Status
		<br/>
		SQA</th>
		<th width="1%"  style="vertical-align:middle; text-align: center">Status
		<br/>
	...
	'<?= $l->SHOP_ID?>');" style="cursor:pointer;">
		...
		<td style="vertical-align:middle; text-align: center"><span class="tool"><?=$img_ot?><span class="tip">DUE DATE <br /><?= (isset($due_date_ot)) ? date('d-M-y', strtotime($due_date_ot)) : '' ?></span></span></td>
		<td style="vertical-align:middle; text-align: center"><span class="tool"><?=$img_of?><span class="tip">DUE DATE  <br /><?= (isset($due_date_of)) ? date('d-M-y', strtotime($due_date_of)) : '' ?></span></span></td>
		<td style="vertical-align:middle; text-align: center"><span class="tool"><?=$img_rt?><span class="tip">DUE DATE  <br /><?= (isset($due_date_rt)) ? date('d-M-y', strtotime($due_date_rt)) : '' ?></span></span></td>
		<td style="vertical-align:middle; text-align: center"><span class="tool"><?=$img_rf?><span class="tip">DUE DATE  <br /><?= (isset($due_date_rf)) ? date('d-M-y', strtotime($due_date_rf)) : '' ?></span></span></td>
		...
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->DESCRIPTION
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->BODYNO
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= ($l->DFCT !='' && $l->PROBLEM_ID != '')?
...
: $l->VINNO
		...
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->CTG_GRP_NM
		?></td>
		<td style="vertical-align:middle; text-align: center"><?php
		...
		//}
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->EXTCLR
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->PRB_SHEET_NUM
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->SQPR_NUM
		?></td>
		...
		?></td>
		<td style="vertical-align:middle; text-align: center"><?
			if ($l -> REG_OUT != '') { echo date('d-M-Y H:i:s', strtotime($l -> REG_OUT));
			}
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->AUDITOR_NM_1
		?></td>
		<td style="vertical-align:middle; text-align: center"><?= $l->AUDITOR_NM_2
		?></td>
		<td style="vertical-align:middle; text-align: center"><span class=tool><?= ($l->REG_IN != '' && $l->CHECK_PDATE == '') ? '<img src="' . base_url(). 'assets/style/images/sqa_blank.gif" width="20" heigth="15"/>' : ''
			?><span class="tip">NOT YET <br/>CHECKED</span></span><span class=tool> <?= ($l->REG_IN != '' && $l->CHECK_PDATE != '' && $l->APPROVE_PDATE == '') ? '<img src="' . base_url(). 'assets/style/images/checked.gif" width="20" heigth="20"/>' : ''
			?><span class="tip">CHECKED</span></span><span class=tool><?= ($l->APPROVE_PDATE != '') ? '<img src="' . base_url(). 'assets/style/images/approved.gif" width="20" heigth="20" />' : ''
			?><span class="tip">APPROVE <br/>/ <?= date("d-M-y",strtotime($l->APPROVE_PDATE)) ?></span></span></td>
		<td style="vertical-align:middle; text-align: center"><?= ($l->APPROVE_PDATE != '' && $l->SHOW_FLG == '1') ? ' <span class=tool><img src="' . base_url(). 'assets/style/images/show.gif" width="20" heigth="20"/><span class="tip"> '. $l->DESCRIPTION .' </span></span>  ' : ''
		?></td>
	</tr>
	<?php
	$i++;
