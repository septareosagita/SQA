<table class="data" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr class="row-<?=($i%2==0)?'a':'b'?>">
        <td><?=$i?></td>
        <td>
            <?php if (file_exists(PATH_ATTCH . $a->SQPR_DOC)) : ?>
            <a href="<?=site_url('welcome/download_file/' . AsciiToHex(base64_encode($a->SQPR_NAME.';'.PATH_ATTCH . $a->SQPR_DOC)))?>"><?=$a->SQPR_NAME?></a>
            <?php endif; ?>
        </td>
        <td>
