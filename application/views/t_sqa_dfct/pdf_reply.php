...
<body >
<div class="widget" >
<div style="margin-left:5px;margin-top:175px; position: absolute; border-bottom:double; border-left:double;border-top:double; width:261px; height:230px">SKETCH :<br /><img src="<? echo PATH_IMG_URL.$main_img;?>" class="mustresize" /><div align="center">Main Image</div></div>
<div style="margin-top:175px; margin-left:264px; position: absolute; border-bottom:double; border-right:double;border-top:double;height:230px"><br /><img src="<? echo PATH_IMG_URL.$part_img;?>" class="mustresize" /><div align="center">Part Image</div></div>
...
<div style="margin-left:520px; width:750px; margin-top:10px">
 <table width="526" border="0" align="left">
   <tr>
    ...
    <td colspan="2" valign="top" nowrap="nowrap"><p><span class="style1">:&nbsp;<?=$auditor1;?>
      <br />:&nbsp;<?= $auditor2;?>
    <br />
    :</span><span class="style1">&nbsp;<?= $plant_nm;?>
    </span><br />
    <span class="style1">:</span>&nbsp;<?= $dfct_stall; ?><br />
    &nbsp;<br />
    ...
    <td width="79" valign="top" nowrap="nowrap"><p><span class="style1">
      Checked By</span><br />
    <span class="style1">Approve  By </span></p></td>
...
<div style="margin-top:340px;width:250px;background:#CCCCCC; font-weight:bold;"><left>DETAIL PROBLEM</left></div>
    <div style="height:100px; border:solid; width:1000px">
        <div style="margin-left:5px;width:110px;float:left">Actual</div>
        <div style="width:270px;float:left">:&nbsp;<?= $measurement;?></div>
        <div style="width:150px;float:left">Inspection Item</div>
        ...
        <div style="margin-left:5px;width:110px;float:left">Standard</div>
        <div style="width:270px;float:left">:&nbsp;<?= $refval;?></div>
        <div style="width:150px;float:left">Quality Gate Item</div>
        <div style="width:450px;float:left">:&nbsp;<?= $qlty_gt_item;?></div>
        <div style="margin-left:5px;width:110px;float:left">Rank</div>
        <div style="width:270px;float:left">:&nbsp;<?=$rank_nm; ?></div>
        <div style="width:150px;float:left">History Repair Process</div>
        <div style="width:450px;float:left">:&nbsp;<?=$repair_flg;?></div>
        <div style="margin-left:5px;width:110px;float:left">Category Group</div>
        <div style="width:270px;float:left">:&nbsp;<?=$ctg_grp_nm; ?></div>
        <div style="width:150px;float:left">Confirmed by QCD</div>
        <div style="width:190px;float:left">:&nbsp;<? $confby='';foreach($list_dfct_conf as $i): if ($i->CONF_TYPE=='0') $confby=$confby.','.$i->CONF_BY; endforeach; 
		echo substr($confby,1.200);?></div>
        <div style="width:85px;float:left">Related Div</div>
        <div style="width:100px;float:left">:&nbsp;<? $confby='';foreach($list_dfct_conf as $i): if ($i->CONF_TYPE=='1') $confby=$confby.','.$i->CONF_BY; endforeach;
		echo substr($confby,1.200);?></div>
        <div style="margin-left:5px;width:110px;float:left">Category Name</div>
...
<div style="margin-top:5px;width:250px;background:#CCCCCC; font-weight:bold"><left>INVESTIGATION RESULT</left></div>
    <div style="height:660px; border:solid; width:1000px ">
        ...
        <div style="width:250px;float:left">Due Date :&nbsp;<? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->DUE_DATE;} endforeach;?></div>
        ...
        <tr>
          ...
          <td width="225" nowrap="nowrap"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->REPLY_USERID.' - '.$ii->REPLY_SYSDATE;} endforeach;?>
            <br />
          <? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->Updateby.' - '.$ii->updatedt;} endforeach;?></td>
          <td width="96" nowrap>Approved by</td>
          <td width="7" nowrap="nowrap">:&nbsp;</td>
          <td width="208"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->APPROVED_BY.' - '.$ii->APPROVE_SYSDATE;} endforeach;?></td>
          <div class="buttonreg">
...
<br/>
        ...
        <div style="width:250px;float:left">Due Date :&nbsp;<? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->DUE_DATE;} endforeach;?></div>
        <div style="width:190px;float:left">Status :&nbsp;
        <? 
		foreach($list_reply as $ii):
      ...
      <table width="100%" border="0" style="margin-left:12px">
        ...
        <tr>
          ...
          :&nbsp;</td>
          <td width="225" nowrap="nowrap"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->REPLY_USERID.' - '.$ii->REPLY_SYSDATE;} endforeach;?>
            <br />
          <? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->Updateby.' - '.$ii->updatedt;} endforeach;?></td>
          <td width="96" nowrap>Approved by</td>
          <td width="7">:&nbsp;</td>
          <td width="208"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='O' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->APPROVED_BY.' - '.$ii->APPROVE_SYSDATE;} endforeach;?></td>
          <div class="buttonreg">
      ...
      <div style="margin-left:18px;width:200px;float:left">a. Temporary Action</div>
        <div style="width:250px;float:left">Due Date :&nbsp;<? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->DUE_DATE;} endforeach;?></div>
      ...
      <table width="100%" border="0" style="margin-left:12px">
        ...
        <tr>
          ...
          :&nbsp;</td>
          <td width="225" nowrap="nowrap"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->REPLY_USERID.' - '.$ii->REPLY_SYSDATE;} endforeach;?>
            <br />
          <? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->Updateby.' - '.$ii->updatedt;} endforeach;?></td>
          <td width="96" nowrap>Approved by</td>
          <td width="7">:&nbsp;</td>
          <td width="208"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='T') { echo $ii->APPROVED_BY.' - '.$ii->APPROVE_SYSDATE;} endforeach;?></td>
          <div class="buttonreg">
...
<br/>
		<div style="margin-left:18px;width:200px;float:left;">b. Fix Action</div>
        <div style="width:250px;float:left">Due Date :&nbsp;<? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->DUE_DATE;} endforeach;?></div>
        <div style="width:190px;float:left">Status :&nbsp;
        <? 
		foreach($list_reply as $ii):
      ...
      <table width="100%" border="0" style="margin-left:12px">
        ...
        <tr>
          ...
          <td width="225px" nowrap="nowrap"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->REPLY_USERID.' - '.$ii->REPLY_SYSDATE;} endforeach;?>
            <br />
          <? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->Updateby.' - '.$ii->updatedt;} endforeach;?></td>
          <td width="96" nowrap>Approved by</td>
          <td width="4">:&nbsp;</td>
          <td width="215"><? 
			foreach($list_reply as $ii): if ($ii->REPLY_TYPE=='R' && $ii->COUNTERMEASURE_TYPE=='F') { echo $ii->APPROVED_BY.' - '.$ii->APPROVE_SYSDATE;} endforeach;?></td>
          <div class="buttonreg">
          <td align="right" width="98"><input disabled='disabled' class="button button-gray" type ='hidden'  name='edit' id='edit' value='         Edit        '>          </td>
